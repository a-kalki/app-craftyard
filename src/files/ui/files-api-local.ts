import { failure, success, type ResultDTO } from "rilata/core";
import type { FileApi } from "./files-api";
import type { FileUploadResult, UploadFileInput, UploadFileUcMeta } from "../domain/struct/upload-file";
import type { GetFileCommand, GetFileEntryResult, GetFileUcMeta } from "../domain/struct/get-file";
import { type UpdateFileCommand, type UpdateFileResult, type UpdateFileUcMeta } from "../domain/struct/update-file";
import { type DeleteFileCommand, type DeleteFileResult, type DeleteFileUcMeta } from "../domain/struct/delete-file";
...
class FileBackendApi extends BaseBackendApi<unknown> implements FileApi {
...
export const fileApi = new FileBackendApi(fileApiUrls, jwtDecoder)
