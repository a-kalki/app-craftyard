...
import { timeStampValidator, userIdValidator, uuidFieldValidator } from "#app/domain/base-validators";
...
const IndividualCommissionVmap: ValidatorMap<IndividualCommission> = {
  ...
  appliedByStaffId: userIdValidator.cloneWithName('appliedByStaffId'),
...
const workshopMembershipVmap: ValidatorMap<WorkshopMembership> = {
  id: uuidFieldValidator,
  userId: userIdValidator.cloneWithName('userId'),
  workshopId: uuidFieldValidator.cloneWithName('workshopId'),
  ...
  joinedAt: timeStampValidator.cloneWithName('joinedAt'),
...
export const workshopVmap: ValidatorMap<WorkshopAttrs> = {
    ...
    subscriptionPlans: new DtoFieldValidator(
      'subscriptionPlans', true, { isArray: true }, 'dto', subsriptionPlanVmap,
    ),
    commissionStrategy: new DtoFieldValidator(
      'commissionStrategy', true, { isArray: false }, 'dto', commissionStrategyVmap,
    ),
    individualCommissions: new DtoFieldValidator(
      'individualCommissions', true, { isArray: true }, 'dto', IndividualCommissionVmap,
    ),
