...
import type { DeleteFileCommand } from "#files/domain/struct/delete-file/contract";
import { deleteModelImageValidator } from "#models/domain/struct/delete-image/v-map";
